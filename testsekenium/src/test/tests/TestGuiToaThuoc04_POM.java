...
public class TestGuiToaThuoc04_POM {
    public static void main(String[] args) {
        ExtentReportManager.initReports();
        ExtentTest test = ExtentReportManager.createTest("TestGuiToaThuoc04", "Gửi toa thuốc - Số lượng thuốc lớn (1001)");
        ...
        try {
            ...
            chiTietPage.nhapToaThuoc("Viêm họng cấp", 1, "1001", "Uống 1 viên/ngày");

            chiTietPage.takeScreenshot("GuiToaThuoc_04_Success");
            test.log(Status.PASS, "✅ Test số lượng lớn");
