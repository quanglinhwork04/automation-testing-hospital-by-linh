...
public class TestDatLich11_POM {
    public static void main(String[] args) {
        ExtentReportManager.initReports();
        ExtentTest test = ExtentReportManager.createTest("TestDatLich11", "Đặt lịch thiếu khung giờ");
        ...
        try {
            ...
            datLichPage.nhapNgayKham("29/09/2025");
            ...
            datLichPage.takeScreenshot("DATLICH11.png");

            test.log(Status.PASS, "✅ Đã test thiếu khung giờ");
