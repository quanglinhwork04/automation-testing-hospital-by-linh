...
public class TestDatLich14_POM {
    public static void main(String[] args) {
        ExtentReportManager.initReports();
        ExtentTest test = ExtentReportManager.createTest("TestDatLich14", "Đặt lịch không nhập triệu chứng");
        ...
        try {
            ...
            datLichPage.takeScreenshot("DATLICH14.png");

            test.log(Status.PASS, "✅ Đã test không nhập triệu chứng");
