...
public class TestGuiToaThuoc06_POM {
    public static void main(String[] args) {
        ExtentReportManager.initReports();
        ExtentTest test = ExtentReportManager.createTest("TestGuiToaThuoc06", "Gửi toa thuốc - Không nhập số lượng");
        ...
        try {
            ...
            chiTietPage.nhapToaThuoc("Viêm họng cấp", 1, "", "Uống 1 viên/ngày");

            chiTietPage.takeScreenshot("GuiToaThuoc_06_Success");
            test.log(Status.PASS, "✅ Test không nhập số lượng");
